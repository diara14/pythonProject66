...
cactus_image = pygame.image.load('в/cactus.png')
cactus_image = pygame.transform.scale(cactus_image, (50, 80))
dino_image = pygame.image.load('в/dino.png')
dino_image = pygame.transform.scale(dino_image, (110, 110))
ground_image = pygame.image.load('в/ground.gif')
ground_image = pygame.transform.scale(ground_image, (800, 170))
...
dino = Dino(dino_image, (100, 400), screen)
